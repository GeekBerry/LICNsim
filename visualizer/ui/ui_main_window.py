...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/visualizer/images/node.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.action_edge = QtWidgets.QAction(main_window)
        icon6 = QtGui.QIcon()
        ...
        self.toolbar_view.addAction(self.action_edge)
    ...
    def retranslateUi(self, main_window):
        ...
        self.action_node.setText(_translate("main_window", "节点图"))
