...
class NetScene(QGraphicsScene):
    ...
    def addICNChannel(self, src_id, dst_id):
    ...
    # ------------------------------------------------------------------------------------------------------------------
    def selectPainter(self, painter):
        self.painter= painter
        self.refresh()

    def updatePainter(self, painter):
        if painter is self.painter:
            self.refresh()
    ...
    def refresh(self):
        if self.painter is None:  # DEBUG
            return

        style_dict= self.painter.getStyleDict( self.node_table.keys(), self.edge_table.keys() )
